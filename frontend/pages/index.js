...
const IndexPage = () => {
  ...
  const features = [
    ...
    {
      img: ['/images/intro/features/google-icomoon-fonts.png', 'Google Fonts logo'],
      title: 'Google icomoon-fonts',
      text: 'Finder uses Google font (Noto Sans) which is free, fast to load and of very high quality. Currently Google icomoon-fonts library includes 1000+ font families to choose from.'
    },
    {
