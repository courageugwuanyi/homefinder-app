...
const HomePage = () => {
  ...
  const properties = [
    ...
    const locationOptions = [
        'Abuja (FCT)', 'Abeokuta', 'Abia', 'Adamawa', 'Akwa Ibom',
        'Anambra', 'Bauchi', 'Bayelsa', 'Benin City', 'Benue', 'Borno',
        'Calabar', 'Cross River', 'Delta', 'Ebonyi', 'Edo', 'Ekiti',
        'Enugu', 'Gombe', 'Ibadan', 'Imo', 'Ilorin', 'Jigawa',
        'Jos', 'Kaduna', 'Kano', 'Katsina', 'Kebbi', 'Kogi', 'Kwara',
        'Lagos', 'Maiduguri', 'Nasarawa', 'Niger', 'Ogun', 'Ondo',
        'Osun', 'Oyo', 'Plateau', 'Port Harcourt', 'Rivers', 'Sokoto',
        'Taraba', 'Warri', 'Yobe', 'Zamfara'
    ];
            ...
            <FormGroup className="d-block">
                <Row className="g-0">
                    <Col md={11} className="d-sm-flex align-items-center">
                        ...
                        <div className="position-relative ps-2 ps-sm-3 w-sm-50 border-end-sm d-flex align-items-center">
                            <i className="fi-map-pin me-2 text-muted" aria-hidden="true"></i>
                            <input
                                style={{padding: '0px'}}
                                type="text"
                            ...
                            {showSuggestions && location && filteredSuggestions.length > 0 && (
                                <div className="position-absolute top-100 start-0 w-100 bg-white border rounded shadow-sm mt-1 z-index-1000 mt-2" style={{ zIndex: 1000 }}>
