...
const NotFoundPage = () => {
  ...
  useEffect(() => {
    ...
    if (!isClient || !animationContainer.current) return
              ...
              <Row className='gy-4 align-items-md-center'>
                <Col xs={{order: 'last'}} lg={{span: 4, order: 'first'}} className='position-relative py-lg-0 py-5 text-lg-start text-center'>
                  ...
                  <div className='position-relative zindex-5'>
                    ...
                    <p className='mx-auto mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70' style={{maxWidth: '576px'}}>
                    ...
                    <div className='d-flex flex-sm-row flex-column justify-content-lg-start justify-content-sm-center ms-n4'>
                      <Button as={Link} href='/real-estate' size='lg' variant='primary mt-3 ms-4'>
                        Go to homepage
                      </Button>
                      <Button as={Link} href='/real-estate/help-center' size='lg' variant='outline-light mt-3 ms-4'>
                        Visit help center
                      </Button>
                    </div>
                  </div>
                ...
                <Col xs={{order: 'first'}} lg={{span: 6, order: 'last', offset: 2}}>
                  <div className='ratio ratio-1x1 mx-auto' style={{maxWidth: '636px'}}>
                    {/* Only render animation container on client side */}
                    {isClient && <div ref={animationContainer}></div>}
